  ...
  return (
    <div className="shap-chart">
      {features.map((f) => {
        ...
        return (
          <div key={f.feature} className="shap-chart__row">
            ...
            <div className="shap-chart__track">
              ...
              {positive ? (
                <div className="shap-chart__bar-half shap-chart__bar-half--right">
                  <div className="shap-chart__bar shap-chart__bar--pos" style={{ width: `${widthPct}%` }} />
                </div>
              ) : (
                <div className="shap-chart__bar-half shap-chart__bar-half--left">
                  <div className="shap-chart__bar shap-chart__bar--neg" style={{ width: `${widthPct}%` }} />
                </div>
              )}
            </div>
          </div>
